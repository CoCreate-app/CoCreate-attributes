...
Simple HTML5 & JavaScript component add, update & remove values in element's attributes from input, select or js api. Easy configuration using data -attributes or JS object. Take it for a spin in our [playground!](https://cocreate.app/docs/attributes)
